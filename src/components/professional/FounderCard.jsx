    ...
    <Card padding="lg" className={cn('relative overflow-hidden', className)} surface={surface}>
      ...
      <div className="relative flex flex-col items-start gap-5 sm:flex-row sm:items-center sm:gap-6">
        ...
        <div className="min-w-0 flex-1">
          ...
          <h3 className="mt-1 font-display text-2xl font-semibold leading-tight text-forest-950 dark:text-sage-50">
            {PROFESSIONAL.name}
          </h3>
          <p className="mt-1 text-sm font-medium text-forest-700 dark:text-sage-300">
            {PROFESSIONAL.role}
          </p>
      ...
      <div className="relative mt-5 flex flex-wrap items-center gap-3 border-t border-stone-900/8 pt-5 dark:border-white/10">
        <Link
          ...
          className="inline-flex items-center gap-1.5 text-sm font-semibold text-forest-800 hover:underline dark:text-sage-200"
        >
